...
### ✅ 검증된 테스트 커버리지 (Verified)

- **통합 시나리오**: `http/api-test.http`를 통해 회원가입부터 소설 완결까지 전체 흐름 검증 완료.
- **단위 테스트**: 각 서비스(Member/Story/Reaction)의 핵심 비즈니스 로직에 대해 JUnit5 + Mockito 기반의 견고한 테스트 슈트 구축.
