...
class BookServiceTest {
    ...
    void createBookSuccess() {
        ...
        given(categoryRepository.findById("FANTASY"))
                .willReturn(Optional.of(new com.team2.storyservice.category.entity.Category("FANTASY", "판타지")));
        ...
        then(sentenceRepository).should(times(1)).save(argThat(sentence ->
                sentence.getContent().equals(createBookRequest.getFirstSentence()) &&
